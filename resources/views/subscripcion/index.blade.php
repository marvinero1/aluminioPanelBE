...
<div class="content-wrapper pt-3">
    <h1 style="text-align: center" class="mb-4">Subscriptores</h1>
    <div class="content">
        ...
        <div class="float-left">
            ...
            <button class="btn btn-outline-success my-2 my-sm-0" type="submit" style="border: 1px #3097D1 solid;">
                <span class="search" ></span>&nbsp;Ver Expiracion</button></a>
        </div>
        <div class="float-right">
            <form class="form-inline my-2 my-lg-0">
                <input name="buscarpor" class="form-control mr-sm-2" type="search"
                    placeholder="Buscador Subscriptores" aria-label="Search">
                <button class="btn btn-outline-success my-2 my-sm-0" type="submit" style="border: 1px #3097D1 solid;">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">{{ $users->fecha_inicio }}</td>
                        <td style="text-align:center;">{{ $users->fecha_fin }}</td>
