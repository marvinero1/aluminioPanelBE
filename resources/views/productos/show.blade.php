                    ...
                    <div class="half container-fluid">
                        <div class="row">
                          <div class="featured_text" style="padding-right: 700px;">
                            ...
                            <h5><strong>Disponible en:</strong></h5><p>{{ $producto->disponibilidad}}</p>
                        </div>
                        <div class="featured_text float-right">
                            <h2>Cod. Producto</h2>
                            <h3>{{ $producto->codigo }}</h3><br>
                        </div>  
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="image">
                                    @if( $producto->imagen == '')
                                        <img img src="/images/default-person.jpg" class="img-thumbnail" alt="Producto" width="100%">
                                    @else
                                        <img src="/{{$producto->imagen }}" class="img-thumbnail" alt="Producto" 
                                            style="display: block;margin: 0 auto;width: 100%;">
                                    @endif
                                </div>
                            </div><br>
                            
                            <div class="row" style="width: 70%;justify-content: center; text-align: center;">
                                <div class="col-md-6">
                                    <div class="half">
