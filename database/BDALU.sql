...
-- Volcando datos para la tabla aluminiobd.calculadoras: ~2 rows (aproximadamente)
...
INSERT INTO `calculadoras` (`id`, `numero1`, `numero2`, `resultado`, `user_id`, `deleted_at`, `created_at`, `updated_at`) VALUES
	(1, 25.50, 25.50, 650.30, NULL, NULL, '2021-05-19 02:17:02', '2021-05-19 02:17:02'),
	(2, 10.10, 5.20, 52.50, NULL, NULL, '2021-05-19 02:17:19', '2021-05-19 02:17:19');
...
INSERT INTO `calculadora_historials` (`id`, `total_suma`, `nombre_operacion`, `extra`, `total_extra`, `user_id`, `deleted_at`, `created_at`, `updated_at`) VALUES
	(9, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-19 04:40:24', '2021-05-19 04:40:24');
...
-- Volcando datos para la tabla aluminiobd.carritos: ~0 rows (aproximadamente)
DELETE FROM `carritos`;
/*!40000 ALTER TABLE `carritos` DISABLE KEYS */;
INSERT INTO `carritos` (`id`, `nombre`, `confirmacion`, `imagen`, `precio`, `color`, `ancho`, `alto`, `codigo`, `puntuacion`, `descripcion`, `importadora`, `tipo_medida`, `cantidad_pedido`, `user_id`, `categorias_id`, `subcategorias_id`, `favoritos_id`, `deleted_at`, `created_at`, `updated_at`) VALUES
	(1, 'Carrocería de automóviles', 'false', 'images/productos/10-021543-9.jpg', 2500.00, 'Plomo', NULL, NULL, '000-GTV-032', '5', 'dadasdasdasd', 'admin', 'Selecciona...', '4', NULL, '1', '1', NULL, NULL, '2021-05-19 03:42:39', '2021-05-19 03:42:39'),
	(2, 'Carrocería de automóviles', 'false', 'images/productos/10-021543-9.jpg', 2500.00, 'Plomo', NULL, NULL, '000-GTV-032', '5', 'dadasdasdasd', 'admin', 'Selecciona...', '4', NULL, '1', '1', NULL, NULL, '2021-05-19 03:42:39', '2021-05-19 03:42:39');
...
CREATE TABLE IF NOT EXISTS `carrito_detalles` (
  ...
  KEY `carrito_detalles_productos_id_foreign` (`productos_id`),
  CONSTRAINT `carrito_detalles_carro_id_foreign` FOREIGN KEY (`carro_id`) REFERENCES `carritos` (`id`) ON DELETE CASCADE,
  CONSTRAINT `carrito_detalles_productos_id_foreign` FOREIGN KEY (`productos_id`) REFERENCES `productos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Volcando datos para la tabla aluminiobd.carrito_detalles: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla aluminiobd.categorias: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla aluminiobd.pedidos: ~0 rows (aproximadamente)
DELETE FROM `pedidos`;
...
-- Volcando datos para la tabla aluminiobd.productos: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla aluminiobd.subcategorias: ~1 rows (aproximadamente)
